...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <form id="form-disconnect" class="navbar-form navbar-right" action="script/deconnexion.php" method="post" role="form">
    ...
    <div class="container">
      ...
      <p style="text-align: center;"><img src="img/banniere.png" name="img" id="img"></p>
